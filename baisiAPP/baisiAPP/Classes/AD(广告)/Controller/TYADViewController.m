...
#import "TYADItem.h"
#define adbaseURL  @"http://mobads.baidu.com/cpro/ui/mads.php"
...
- (void)setADImage
{
    ...
    //3.发送网络请求
    [msg GET:adbaseURL parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        //请求成功
